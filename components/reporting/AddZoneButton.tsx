...
import { createZone } from '@/app/(dashboard)/reporting/clients/[id]/sites/actions'
...
export function AddZoneButton({ parentSiteId }: Props) {
  ...
  function submit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const res = await createZone(parentSiteId, trimmed)
      if (res.ok) {
        setOpen(false)
        reset()
        router.refresh()
  ...
  return (
    <>
      ...
      <Modal open={open} title="New zone" onClose={close}>
